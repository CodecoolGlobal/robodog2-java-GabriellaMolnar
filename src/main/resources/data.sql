...
INSERT INTO DOG( BREED, AGE, NAME) values ( 'SPANIEL', 8, 'Béta');
INSERT INTO DOG( BREED, AGE, NAME) values ( 'LABRADOR', 10, 'Gamma');
INSERT INTO DOG( BREED, AGE, NAME) values ( 'VIZSLA', 12, 'Tony');

INSERT INTO PEDIGREE (PUPPY_ID, MOM_ID, DAD_ID) values (3, 1, 2 );
INSERT INTO PEDIGREE (PUPPY_ID, MOM_ID, DAD_ID) values (1, 5, 6 );
INSERT INTO PEDIGREE (PUPPY_ID, MOM_ID, DAD_ID) values (2, 5, 7 );
INSERT INTO PEDIGREE (PUPPY_ID, MOM_ID, DAD_ID) values (4, 8, 6 );
